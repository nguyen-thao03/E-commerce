      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 1 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Chúng tôi thường xử lý và gửi đơn đặt hàng trong vòng 1-2 ngày
                làm việc. Tùy thuộc vào vị trí của bạn, có thể mất thêm 2-7 ngày
                để đơn đặt hàng của bạn đến.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Hiện tại chúng tôi chỉ cung cấp dịch vụ vận chuyển trong phạm vi
                Việt Nam.
              </p>
            </div>
          )}
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                paypal, chúng tôi cũng có hệ thống giao hàng thu tiền.
              </p>
            </div>
          )}
        </div>
